            ...
            switch (SongAdd_SpecialStr_Button.Text)
            {
                ...
                case "移除":
                    if (SongAdd_SpecialStr_ListBox.SelectedItem != null)
                    {
                        ...
                        Global.SongAddSpecialStr = Global.SongAddSpecialStr.Replace(@"\|" + RemoveStr, "");
            ...
            if (SongAdd_Save_Button.Text == "取消加入")
            {
                ...
                if (SelectedRowsCount == 1)
                {
                    ...
                    else
                    {
                        ...
                        List<string> PlayerSongInfoList = new List<string>() { SongId, SongLang, SongSinger, SongSongName, SongTrack, SongVolume, SongReplayGain, SongFilePath, "0", "SongAdd" };
    ...
    class SongAdd
    {
        ...
        public static DataTable GetSongIdentificationModeList()
        {
            using (DataTable dt = new DataTable())
            {
                ...
                List<string> list = new List<string>();
                list = new List<string>() { "智能辨識模式", "歌手_歌名", "歌名_歌手", "歌曲編號_歌手_歌名", "歌曲編號_歌名_歌手", @"歌手\歌名" };
